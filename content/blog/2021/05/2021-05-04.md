...
We've offered some resources on formulation and solution techniques, but what about actually building a solver? First of all, I would suggest against it unless your motivation is purely out of curiousity. Solvers are complex and there are many edge cases that you have to deal with.

Let's say you are committed to the task though and you really wanted to write one. First of all, make sure you grasp the resources in the previous sections. Chvatal's book has some refinements on the Simplex and Dual Simplex that will be critical if you want to write a high-performance solver.
